...
You can generate a class stub from some xml. Simple structure, requires manual cleanup/additions.
...
You can generate a test class stub from some xml. Simple structure, requires manual cleanup/additions.
