...
/**
 * CouponPriceGroupUnassign
 *
 * @author Gassan Idriss <gidriss@mivamerchant.com>
 */
class CouponPriceGroupUnassign implements Model\StoreFragmentInterface
{
    /** @var string */
    public $couponCode;
    ...
    public function toXml($version = Version::CURRENT, array $options = array())
    {
        ...
        $xmlObject = new SimpleXMLElement('<CouponPriceGroup_Unassign />');
