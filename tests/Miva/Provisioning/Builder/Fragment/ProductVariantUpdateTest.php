...
use Miva\Provisioning\Builder\Fragment\ProductVariantUpdate;
...
*/
class ProductVariantUpdateTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $fragment = new ProductVariantUpdate();
        ...
        $expectedXml = '<ProductVariant_Update product_code="test">
            <Options>
