...
use Miva\Provisioning\Builder\Fragment\CustomerLostPasswordEmailUpdate;

/**
* CustomerLostPasswordEmailUpdateTest
*
* @author Gassan Idriss <gidriss@mivamerchant.com>
*/
class CustomerLostPasswordEmailUpdateTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $fragment = new CustomerLostPasswordEmailUpdate();
