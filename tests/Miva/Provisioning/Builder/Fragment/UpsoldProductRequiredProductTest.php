...
use Miva\Provisioning\Builder\Fragment\UpsoldProductRequiredProduct;

/**
 * UpsoldProductRequiredProductTest
 *
 * @author Gassan Idriss <gidriss@mivamerchant.com>
*/
class UpsoldProductRequiredProductTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $fragment = new UpsoldProductRequiredProduct();
