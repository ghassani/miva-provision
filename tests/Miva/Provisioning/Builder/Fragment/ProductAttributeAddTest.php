...
use Miva\Provisioning\Builder\Fragment\ProductAttributeAdd;

/**
* ProductAttributeAddTest
*
* @author Gassan Idriss <gidriss@mivamerchant.com>
*/
class ProductAttributeAddTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $fragment = new ProductAttributeAdd();
