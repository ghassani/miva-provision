...
use Miva\Provisioning\Builder\Fragment\ProductImageDeleteAllProduct;

/**
* ProductImageDeleteAllProductTest
*
* @author Gassan Idriss <gidriss@mivamerchant.com>
*/
class ProductImageDeleteAllProductTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $fragment = new ProductImageDeleteAllProduct();
