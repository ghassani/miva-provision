...
use Miva\Provisioning\Builder\Fragment\CustomerSettingsUpdate;

/**
 * CustomerSettingsUpdateTest
 *
 * @author Gassan Idriss <gidriss@mivamerchant.com>
*/
class CustomerSettingsUpdateTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $fragment = new CustomerSettingsUpdate();
