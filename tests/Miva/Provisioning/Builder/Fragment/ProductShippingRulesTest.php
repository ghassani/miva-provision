...
use Miva\Provisioning\Builder\Fragment\ProductShippingRules;

/**
* ProductShippingRulesTest
*
* @author Gassan Idriss <gidriss@mivamerchant.com>
*/
class ProductShippingRulesTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $fragment = new ProductShippingRules();
