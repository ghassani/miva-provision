...
use Miva\Provisioning\Builder\Fragment\ProductVariantDeleteAll;

/**
* ProductVariantDeleteAllTest
*
* @author Gassan Idriss <gidriss@mivamerchant.com>
*/
class ProductVariantDeleteAllTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $fragment = new ProductVariantDeleteAll();
