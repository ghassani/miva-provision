...
use Miva\Provisioning\Builder\Fragment\ProductVariantGenerate;

/**
* ProductVariantGenerateTest
*
* @author Gassan Idriss <gidriss@mivamerchant.com>
*/
class ProductVariantGenerateTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $fragment = new ProductVariantDelete();
