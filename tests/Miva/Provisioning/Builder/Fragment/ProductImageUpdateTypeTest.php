...
use Miva\Provisioning\Builder\Fragment\ProductImageUpdateType;

/**
* ProductImageUpdateTypeTest
*
* @author Gassan Idriss <gidriss@mivamerchant.com>
*/
class ProductImageUpdateTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $fragment = new ProductImageUpdateType();
