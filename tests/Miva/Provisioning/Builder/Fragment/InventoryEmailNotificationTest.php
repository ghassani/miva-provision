...
use Miva\Provisioning\Builder\Fragment\InventoryEmailNotification;

/**
* InventoryEmailNotificationTest
*
* @author Gassan Idriss <gidriss@mivamerchant.com>
*/
class InventoryEmailNotificationTest extends \PHPUnit_Framework_TestCase
{
