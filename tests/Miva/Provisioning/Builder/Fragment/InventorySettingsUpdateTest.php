...
use Miva\Provisioning\Builder\Fragment\InventorySettingsUpdate;

/**
* InventorySettingsUpdateTest
*
* @author Gassan Idriss <gidriss@mivamerchant.com>
*/
class InventorySettingsUpdateTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $fragment = new InventorySettingsUpdate();
