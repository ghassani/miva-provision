...
use Miva\Provisioning\Builder\Fragment\UpsellSettingsUpdate;

/**
* UpsellSettingsUpdateTest
*
* @author Gassan Idriss <gidriss@mivamerchant.com>
*/
class UpsellSettingsUpdateTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $fragment = new UpsellSettingsUpdate();
