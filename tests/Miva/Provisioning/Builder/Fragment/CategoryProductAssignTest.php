...
use Miva\Provisioning\Builder\Fragment\CategoryProductAssign;

/**
 * CategoryProductAssignTest
 *
 * @author Gassan Idriss <gidriss@mivamerchant.com>
*/
class CategoryProductAssignTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $fragment = new CategoryProductAssign('CategoryCode', 'ProductCode');
