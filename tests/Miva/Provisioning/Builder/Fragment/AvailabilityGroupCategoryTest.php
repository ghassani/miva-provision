...
use Miva\Provisioning\Builder\Fragment\AvailabilityGroupCategory;

/**
 * AvailabilityGroupCategoryTest
 *
 * @author Gassan Idriss <gidriss@mivamerchant.com>
*/
class AvailabilityGroupCategoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $fragment = new AvailabilityGroupCategory();
