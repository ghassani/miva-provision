...
use Miva\Provisioning\Builder\Fragment\ShippingMethodRulesUpdate;

/**
* ShippingMethodRulesUpdateTest
*
* @author Gassan Idriss <gidriss@mivamerchant.com>
*/
class ShippingMethodRulesUpdateTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $fragment = new ShippingMethodRulesUpdate();
